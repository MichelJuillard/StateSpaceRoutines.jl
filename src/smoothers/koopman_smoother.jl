...
function koopman_smoother(regime_indices::Vector{UnitRange{Int}}, y::Matrix{S},
...
function koopman_disturbance_smoother(regime_indices::Vector{UnitRange{Int}}, y::Matrix{S},
